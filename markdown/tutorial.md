...
* Share your **foam/obsidian/markdown** notes in a simple and intuitive way ! Support [roamlike link](roamlike link.md) 
* You can share your foam/obsidian note using this template
* 用简单和直观的方式分享你的foam/obsidian/markdown笔记！支持[链接](链接.md)解析，push自动部署页面，使用这个博客模板即可。
...
| `[Git Flow](Git Flow.md)`            | `[Git Flow](../software/git_flow.md)` |
| `![image.png](image.png.md)`           | `![image.png](../image/imag.png)`      |
| `[#Heading identifiers](#Heading identifiers.md)` | `[Heading identifiers in HTML](#heading-identifiers-in-html)`
| `[Git Flow#Heading](Git Flow#Heading.md)` | `[Git Flow](../software/git_flow.md#heading)` |
